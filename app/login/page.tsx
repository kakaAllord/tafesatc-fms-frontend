...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 relative flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="absolute bottom-0 -right-10 w-72 h-72 bg-emerald-600 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-2000"></div>

      {/* Card */}
      <div className="relative w-full max-w-md bg-white rounded-[32px] shadow-2xl border border-slate-100 p-6 sm:p-8">

        {/* Header */}
        <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-4 mb-8 sm:mb-10 text-center sm:text-left">
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <p className="text-slate-400 mt-2 font-bold italic text-xs sm:text-sm tracking-widest uppercase opacity-60">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                value={username}
                onChange={(e) => setUsername(e.target.value)}
                className="w-full pl-12 pr-4 py-3.5 sm:py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 text-slate-900 transition-all font-semibold sm:font-black placeholder:font-normal placeholder:opacity-30 text-sm sm:text-base"
                placeholder="Enter family name"
                required
              />
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-slate-900 hover:bg-black disabled:bg-slate-400 text-white font-bold sm:font-black py-3.5 sm:py-4 rounded-2xl shadow-xl shadow-slate-900/10 transition-all active:scale-[0.97] flex items-center justify-center gap-3 mt-6 uppercase tracking-widest text-xs sm:text-sm italic"
          >
            {loading ? (
              <>
                <Loader2 className="animate-spin" size={20} />
        ...
        <div className="mt-10 sm:mt-12 text-center">
          <p className="text-[9px] sm:text-[10px] font-black text-slate-300 uppercase tracking-[0.3em] italic">
            © 2026 TAFES ATC
          </p>
        </div>
      </div>
