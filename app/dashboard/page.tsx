            ...
            <div className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="mb-12">
                    <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-2 uppercase italic">
                        The <span className="text-blue-600 font-black">Family</span> Hub
                    </h1>
                    <p className="text-slate-400 font-bold italic text-sm tracking-widest uppercase opacity-70">Central coordination & management</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <Link href="/attendance" className="group relative bg-white p-8 rounded-[32px] shadow-sm border border-slate-200 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300 overflow-hidden flex flex-col">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-500 text-sm font-medium leading-relaxed max-w-[200px]">Report presence for your family entities in today's session.</p>
                        </div>
                    </Link>
                    ...
                    <Link href="/child/add" className="group relative bg-white p-8 rounded-[32px] shadow-sm border border-slate-200 hover:border-emerald-500/50 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-300 overflow-hidden flex flex-col">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-2xl font-black text-slate-800 tracking-tight uppercase italic mb-1">New Entity</h2>
                            <p className="text-slate-400 font-bold italic text-xs tracking-widest uppercase opacity-70 mb-4">Child registration</p>
                            <p className="text-slate-500 text-sm font-medium leading-relaxed max-w-[200px]">Expand your family core by adding new members to the system.</p>
                        </div>
                    </Link>
                </div>
                ...
                <div className="mt-12 text-center">
                    <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em] italic">
                        © 2026 TAFES Burundi Core • Localized Node
                    </p>
                </div>
            </div>
        </div>
